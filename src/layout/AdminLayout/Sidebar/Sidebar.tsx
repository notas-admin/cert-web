  ...
  return (
    ...
    >
      <div className="sidebar-brand d-none d-md-flex align-items-center justify-content-center">
        <Image className="sidebar-brand-full" src="/assets/brand/cert.png" width={118} height={46} alt="Cert-Web"/>
        <Image className="sidebar-brand-narrow d-none" src="/assets/brand/cert_pq.png" width={46} height={46} alt="Cert-Web"/>
      </div>
